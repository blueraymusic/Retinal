...
if original_img and gradcam_img:
    st.markdown("### Retinal Scan & Heatmap")
    col1, col2 = st.columns([1, 1], gap="large")

    with col1:
        st.markdown(
            """
            <div style="padding: 10px; background: linear-gradient(135deg, #E8F6F3, #D6EAF8); border-radius: 12px; 
    ...
    with col2:
        st.markdown(
            ...
            <div style="padding: 10px; background: linear-gradient(135deg, #E8F6F3, #D6EAF8); border-radius: 12px; 
            box-shadow: 0px 2px 6px rgba(0,0,0,0.1); text-align: center;">
            <h4 style="color:#2E4053;">Attention Heatmap</h4>
            </div>
            """, unsafe_allow_html=True
        )
